...
export const WalletBalanceDisplay: FC = () => {
	...
	const balance = (walletData?.balance ?? 0) / 1_000_000
	...
	const adjustedRate = exchangeRate?.price?.usdt_rub
		? exchangeRate.price.usdt_rub + 0.5
		: undefined

	const rubValue =
		adjustedRate !== undefined ? (balance * adjustedRate).toFixed(2) : '0.00'
